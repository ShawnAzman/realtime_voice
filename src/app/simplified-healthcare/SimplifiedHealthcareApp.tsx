...
import healthcareAgents from "../agentConfigs/healthcareAppointment";
...
function SimplifiedHealthcareApp() {
    ...
    <div className="text-base flex flex-col h-screen bg-gray-100 text-gray-800 relative">
      <div className="p-5 text-lg font-semibold flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div>
            Healthcare Assistant <span className="text-gray-500">Demo</span>
          </div>
        </div>
      </div>
      ...
      <BottomToolbar
        ...
        isEventsPaneExpanded={false} // Not used in simplified version
        setIsEventsPaneExpanded={() => {}} // Not used in simplified version
...
export default SimplifiedHealthcareApp;
